...
| `web.deploymentAnnotations`                                   | Extra annotations for the web Deployment                                                                                                    | `{}`                                                                                                             |
| `web.deploymentLabels`                                        | Extra labels for the web Deployment                                                                                                         | `{}`                                                                                                             |
...
| `worker.deploymentAnnotations`                                | Extra annotations for the worker Deployment                                                                                                 | `{}`                                                                                                             |
| `worker.deploymentLabels`                                     | Extra labels for the worker Deployment                                                                                                      | `{}`                                                                                                             |
...
| `workerBeat.deploymentAnnotations`                            | Extra annotations for the workerBeat Deployment                                                                                             | `{}`                                                                                                             |
| `workerBeat.deploymentLabels`                                 | Extra labels for the workerBeat Deployment                                                                                                  | `{}`                                                                                                             |
...
| `terminal.deploymentAnnotations`                                   | Extra annotations for the terminal Deployment                                                                                                    | `{}`             |
| `terminal.deploymentLabels`                                        | Extra labels for the terminal Deployment                                                                                                         | `{}`             |
