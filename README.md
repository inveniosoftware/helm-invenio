...
| `httpRoute.enabled`                       | Enables a HTTPRoute object for ingress traffic via Gateway API.                                                                  | `false`                           |
| `httpRoute.annotations`                   | Additional annotations for the HTTPRoute.                                                                                        | `{}`                              |
| `httpRoute.labels`                        | Additional labels for the HTTPRoute.                                                                                             | `{}`                              |
| `httpRoute.parentRefs`                    | Adds parentRefs to the HTTPRoute.                                                                                                | `[]`                              |
...
| `invenio.extraVolumeMounts`               | Extra volumeMounts for all Invenio containers.                                                                                   | `[]`                              |
| `invenio.extraVolumes`                    | Extra volumes for all Invenio pods.                                                                                              | `[]`                              |
...
| `web.annotations`                                             | DEPRECATED: Use `.Values.web.service.annotations` instead!                                                                                  | `{}`                                                                                                             |
| `web.podLabels`                                               | Add extra labels to the Invenio webs pods                                                                                                   | `{}`                                                                                                             |
| `web.podAnnotations`                                          | Add extra annotations to the Invenio web pods                                                                                               | `{}`                                                                                                             |
| `web.affinity`                                                | Affinity rules for web pods assignment                                                                                                      | `{}`                                                                                                             |
...
| `worker.extraVolumeMounts`                                    | Extra volumeMounts for the worker container.                                                                                                | `[]`                                                                                                             |
| `worker.extraVolumes`                                         | Extra volumes for the worker Pod.                                                                                                           | `[]`                                                                                                             |
...
| `worker.affinity`                                             | Affinity rules for worker pods assignment                                                                                                   | `{}`                                                                                                             |
...
| `workerBeat.extraVolumeMounts`                                | Extra volumeMounts for the worker beat container.                                                                                           | `[]`                                                                                                             |
| `workerBeat.extraVolumes`                                     | Extra volumes for the worker beat Pod.                                                                                                      | `[]`                                                                                                             |
...
| `workerBeat.affinity`                                         | Affinity rules for workerBeat pods assignment                                                                                               | `{}`                                                                                                             |
...
| `workerBeat.commandOverride`                                  | Optional override for the worker-beat startup command.                                                                                      | `""`                                                                                                             |
| `workerScheduler.enabled`                                     | Enable the Invenio jobs scheduler.                                                                                                          | `true`                                                                                                           |
| `workerScheduler.class`                                       | Scheduler class used by Celery beat.                                                                                                        | `invenio_jobs.services.scheduler:RunScheduler`                                                                   |
| `workerScheduler.extraEnvVars`                                | Extra environment variables to be added to the pods.                                                                                        | `[]`                                                                                                             |
| `workerScheduler.resources`                                   | `resources` for the scheduler container                                                                                                     | `{}`                                                                                                             |
| `workerScheduler.securityContext`                             | securityContext for the scheduler container                                                                                                 |                                                                                                                  |
| `workerScheduler.securityContext.allowPrivilegeEscalation`    | set container's security context allowprivilegeescalation # @param web.securityContext.capabilities.drop list of capabilities to be dropped | `false`                                                                                                          |
| `workerScheduler.securityContext.capabilities.drop`           | list of capabilities to be dropped                                                                                                          | `["ALL"]`                                                                                                        |
| `workerScheduler.podSecurityContext`                          | securityContext for the scheduler pod                                                                                                       |                                                                                                                  |
| `workerScheduler.extraEnvFrom`                                | Extra secretRef or configMapRef for the `envFrom` field in the scheduler container (templated).                                             | `[]`                                                                                                             |
| `workerScheduler.podLabels`                                   | Add extra labels to the Invenio workerScheduler pods                                                                                        | `{}`                                                                                                             |
| `workerScheduler.podAnnotations`                              | Add extra annotations to the Invenio workerScheduler pods                                                                                   | `{}`                                                                                                             |
| `workerScheduler.affinity`                                    | Affinity rules for workerScheduler pods assignment                                                                                          | `{}`                                                                                                             |
| `workerScheduler.nodeSelector`                                | Node labels for workerScheduler pods assignment                                                                                             | `{}`                                                                                                             |
| `workerScheduler.tolerations`                                 | Tolerations for workerScheduler pods assignment                                                                                             | `[]`                                                                                                             |
| `workerScheduler.livenessProbe`                               | templated `livenessProbe` for the worker-scheduler container                                                                                |                                                                                                                  |
| `workerScheduler.readinessProbe`                              | templated `readinessProbe` for the scheduler container                                                                                      | `nil`                                                                                                            |
| `workerScheduler.startupProbe`                                | templated `startupProbe` for the scheduler container                                                                                        | `nil`                                                                                                            |
| `workerScheduler.deployment.annotations`                      | Extra annotations for the workerScheduler Deployment                                                                                        | `{}`                                                                                                             |
| `workerScheduler.deployment.labels`                           | Extra labels for the workerScheduler Deployment                                                                                             | `{}`                                                                                                             |
| `workerScheduler.deployment.spec`                             | Configuration for other configurable fields in the Deployment.spec.                                                                         |                                                                                                                  |
| `workerScheduler.deployment.spec.minReadySeconds`             | See API spec for `Deployment.spec.minReadySeconds                                                                                           | `nil`                                                                                                            |
| `workerScheduler.deployment.spec.paused`                      | See API spec for `Deployment.spec.paused                                                                                                    | `nil`                                                                                                            |
| `workerScheduler.deployment.spec.progressDeadlineSeconds`     | See API spec for `Deployment.spec.progressDeadlineSeconds                                                                                   | `nil`                                                                                                            |
| `workerScheduler.deployment.spec.revisionHistoryLimit`        | See API spec for `Deployment.spec.revisionHistoryLimit                                                                                      | `nil`                                                                                                            |
| `workerScheduler.deployment.spec.strategy.type`               | Deployment strategy type.                                                                                                                   | `Recreate`                                                                                                       |
| `workerScheduler.commandOverride`                             | Optional override for the scheduler startup command.                                                                                        | `""`                                                                                                             |
...
| `persistence.useSubPath`                                           | Enable or disable usage of subPath for PVC mounts.                                                                                               | `true`           |
...
| `opensearchExternal`                                | External Opensearch configuration                                                                                                           | `{}`                                  |
| `opensearchExternal.auth.enabled`                   | Enable credentials for http_auth to the OpenSearch endpoint.                                                                                |                                       |
| `opensearchExternal.auth.usernameEnv`               | Stanza for the username variable for authentication to the OpenSearch endpoint. Same format as EnvVar items in the containers[].env field.  |                                       |
| `opensearchExternal.auth.passwordEnv`               | Stanza for the password variable for authentication to the OpenSearch endpoint. Same format as EnvVar items in the containers[].env field.  |                                       |
| `opensearchExternal.encryption.enabled`             | Enables TLS encryption for the connection to the OpenSearch endpoint.                                                                       |                                       |
| `opensearchExternal.encryption.caCert.mountPath`    | Mount path for the OpenSearch endpoint's CA certificate.                                                                                    |                                       |
| `opensearchExternal.encryption.caCert.secretKey`    | The key in the secret containing the OpenSearch endpoint's CA certificate.                                                                  |                                       |
| `opensearchExternal.encryption.caCert.secretName`   | The name of the secret containing the OpenSearch endpoint's CA certificate.                                                                 |                                       |
| `opensearchExternal.hostname`                       | The hostname of the OpenSearch endpoint.                                                                                                    |                                       |
| `opensearchExternal.port`                           | The port number of the OpenSearch endpoint.                                                                                                 |                                       |
