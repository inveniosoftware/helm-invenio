...
| `workerScheduler.resources`                                   | `resources` for the worker-beat container                                                                                                   | `{}`                                                                                                             |
| `workerScheduler.securityContext`                             | securityContext for the worker-beat container                                                                                               |                                                                                                                  |
...
| `workerScheduler.podSecurityContext`                          | securityContext for the worker-beat pod                                                                                                     |                                                                                                                  |
| `workerScheduler.podSecurityContext.runAsNonRoot`             | TODO:                                                                                                                                       | `true`                                                                                                           |
| `workerScheduler.podSecurityContext.runAsUser`                | TODO:                                                                                                                                       | `1000`                                                                                                           |
| `workerScheduler.podSecurityContext.runAsGroup`               | TODO:                                                                                                                                       | `1000`                                                                                                           |
| `workerScheduler.podSecurityContext.seccompProfile.type`      | TODO:                                                                                                                                       | `RuntimeDefault`                                                                                                 |
| `workerScheduler.extraEnvFrom`                                | Extra secretRef or configMapRef for the `envFrom` field in the worker-beat container (templated).                                           | `[]`                                                                                                             |
| `workerScheduler.extraVolumeMounts`                           | Extra volumeMounts for the worker beat container.                                                                                           | `[]`                                                                                                             |
| `workerScheduler.extraVolumes`                                | Extra volumes for the worker beat Pod.                                                                                                      | `[]`                                                                                                             |
...
| `workerScheduler.livenessProbe.exec.command`                  | TODO:                                                                                                                                       | `["/bin/bash","-c","celery -A {{ .Values.worker.app }} inspect ping"]`                                           |
| `workerScheduler.livenessProbe.initialDelaySeconds`           | TODO:                                                                                                                                       | `20`                                                                                                             |
| `workerScheduler.livenessProbe.timeoutSeconds`                | TODO:                                                                                                                                       | `30`                                                                                                             |
| `workerScheduler.readinessProbe`                              | templated `readinessProbe` for the worker-beat container                                                                                    | `nil`                                                                                                            |
| `workerScheduler.startupProbe`                                | templated `startupProbe` for the worker-beat container                                                                                      | `nil`                                                                                                            |
...
| `workerScheduler.deployment.spec.strategy`                    | See API spec for `Deployment.spec.strategy                                                                                                  | `nil`                                                                                                            |
